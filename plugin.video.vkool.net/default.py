...
mysettings = xbmcaddon.Addon(id='plugin.video.vkool.net')
...
def addDir(name, url, mode, iconimage,edit, inum, gname):
    ...
    contextmenuitems = []
    if edit:
        contextmenuitems.append(('[COLOR red]Delete[/COLOR] [COLOR ffffd700]Search[/COLOR]','XBMC.Container.Update(%s?url=%s&mode=8&name=%s&inum=%d)'%('plugin://plugin.video.vkool.net',urllib.quote_plus(url),urllib.quote_plus(name),inum)))
        contextmenuitems.append(('[COLOR ff00ff00]Edit[/COLOR] [COLOR ffffd700]Search[/COLOR]','XBMC.Container.Update(%s?url=%s&mode=9&name=%s&inum=%d)'%('plugin://plugin.video.vkool.net',urllib.quote_plus(url),urllib.quote_plus(name),inum)))
...
def addLink(name,url,mode,iconimage,gname,inum):
    ...
    contextmenuitems = []
    contextmenuitems.append(('[COLOR yellow]Download[/COLOR]','XBMC.Container.Update(%s?url=%s&gname=%s&mode=10)'%('plugin://plugin.video.vkool.net',urllib.quote_plus(url),urllib.quote_plus(gname))))
    contextmenuitems.append(('[COLOR ff1e90ff]Add To Library[/COLOR]','XBMC.Container.Update(%s?url=%s&gname=%s&mode=11)'%('plugin://plugin.video.vkool.net',urllib.quote_plus(url),urllib.quote_plus(gname))))
    contextmenuitems.append(('[COLOR ff1e90ff]Add Season To Library[/COLOR]','XBMC.Container.Update(%s?url=%s&gname=%s&inum=%s&mode=12)'%('plugin://plugin.video.vkool.net',urllib.quote_plus(url),urllib.quote_plus(gname), urllib.quote_plus(str(inum)))))
    liz.addContextMenuItems(contextmenuitems,replaceItems=False)
