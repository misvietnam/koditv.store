...
def Oo0oO0oo0oO00 ( cid ) :
 ...
 return json . loads ( Oo0o0000o0o0 ) [ "data" ] [ 0 ] [ "url" ]
 if 86 - 86: iiiii11iII1 % O0o
def I11 ( key , enc ) :
 oO0 = [ ]
 enc = base64 . urlsafe_b64decode ( enc )
 for IIIi1i1I in range ( len ( enc ) ) :
  OOoOoo00oo = key [ IIIi1i1I % len ( key ) ]
  iiI11 = chr ( ( 256 + ord ( enc [ IIIi1i1I ] ) - ord ( OOoOoo00oo ) ) % 256 )
  oO0 . append ( iiI11 )
 return "" . join ( oO0 )
 if 91 - 91: oOOOO / I1IiiI + O0o + OOo00O0Oo0oO
